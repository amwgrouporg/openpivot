...
9. Network-provider data initially used ambiguous provider language. It is now labelled as network-allocation and organization context and defaults to the non-attributive `associated_with` relationship pending analyst review.
