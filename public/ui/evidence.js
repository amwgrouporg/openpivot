...
function evidenceCard(caseData, evidence) {
  ...
  return `<article class="evidence-card card" data-evidence-id="${escapeHtml(evidence.id)}" tabindex="-1"><div class="card-body">
